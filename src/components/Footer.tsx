...
<div>
  ...
  <ul className="mt-4 space-y-3 text-sm">
    ...
    <li>
      <a
        href="mailto:hello@upense.com"
        className="group inline-flex items-center gap-2 text-[#A3AEC2] transition-colors hover:text-[#EBF1FF]"
        aria-label="Написать на hello@upense.com"
      >
        {/* Иконка конверта */}
        <svg
          aria-hidden
        ...
        {/* Текст + подчёркивание как в навигации (подчеркивается только текст) */}
    ...
    <li>
      <a
        ...
        className="group inline-flex items-center gap-2 text-[#A3AEC2] transition-colors hover:text-[#EBF1FF]"
        aria-label="Открыть Telegram @upense_dev"
      >
        {/* Иконка Telegram (чуть крупнее для визуального баланса) */}
        <svg
          aria-hidden
          className="h-[18px] w-[18px] opacity-80 group-hover:opacity-100"
          viewBox="0 0 24 24"
          fill="currentColor"
        >
